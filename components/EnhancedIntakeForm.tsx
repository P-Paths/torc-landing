...
const EnhancedIntakeForm: React.FC = () => {
      ...
      <div className="max-w-2xl mx-auto p-6 bg-green-50 border border-green-200 rounded-lg">
        <div className="text-center">
          ...
          <p className="text-green-700 mb-6">
            Your gaming assessment has been submitted successfully to our secure database. Our specialists will contact you within 24 hours.
          </p>
          <div className="bg-white p-4 rounded-lg border">
            <h3 className="font-semibold text-gray-800 mb-2">Next Steps:</h3>
            <ul className="text-sm text-gray-600 space-y-1">
              <li>• You&apos;ll receive a confirmation email</li>
              <li>• Our gaming addiction specialist will call you</li>
              <li>• We&apos;ll discuss treatment options and next steps</li>
            </ul>
          </div>
        </div>
      </div>
    ...
    <div className="max-w-4xl mx-auto p-6">
      ...
      <div className="mb-8">
        <div className="flex justify-between mb-2">
          {['Contact Info', 'Gaming Profile', 'Assessment', 'Treatment', 'Review'].map((step, index) => (
        ...
        <div className="bg-white p-6 rounded-lg shadow-lg">
          ...
          <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                {[
                  ...
                  <label key={pattern} className="flex items-center space-x-2">
                    <input
                      type="checkbox"
                      checked={formData.schedule.includes(pattern)}
                      onChange={(e) => updateArrayField('schedule', pattern, e.target.checked)}
                      className="rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                    />
                    <span className="text-sm text-black">{pattern}</span>
                  </label>
                ))}
              </div>
            </div>
            ...
            <div>
              ...
              {formData.primaryGames.includes('Other') && (
                <div className="mt-3">
                  <label className="block text-sm font-medium text-gray-700 mb-2">
                    Other Games (please specify)
                  </label>
                  <textarea
                    placeholder="List any other games not mentioned above"
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-black placeholder-gray-500 bg-white"
                    rows={2}
                  />
                </div>
      ...
      {currentStep === 4 && (
        <div className="bg-white p-6 rounded-lg shadow-lg">
          <h2 className="text-2xl font-bold text-gray-800 mb-6">Treatment Options & Preferences</h2>
          ...
          <div className="space-y-6">
                ...
                {[
                  ...
                  <label key={helpType} className="flex items-center space-x-2">
                    <input
                      ...
                      name="helpType"
                      value={helpType}
                      checked={formData.helpType === helpType}
                      onChange={(e) => updateFormData('helpType', e.target.value)}
                      className="text-blue-600 focus:ring-blue-500"
                    />
                    <span className="text-sm text-black">{helpType}</span>
                  </label>
                ))}
              </div>
            </div>
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-3">
                Have you tried any interventions before?
              </label>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                {[
                  ...
                  <label key={attempt} className="flex items-center space-x-2">
                    <input
                      ...
                      onChange={(e) => updateArrayField('previousAttempts', attempt, e.target.checked)}
                      className="rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                    />
                    <span className="text-sm text-black">{attempt}</span>
                  </label>
                ))}
              </div>
            </div>
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => updateFormData('zoomLink', e.target.value)}
                placeholder="https://zoom.us/j/1234567890"
                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-black placeholder-gray-500 bg-white"
              />
              <p className="text-xs text-gray-500 mt-1">
                Paste the Zoom link if you&apos;ve scheduled a meeting with the family
              </p>
            </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-lg">
          ...
          <div className="space-y-4 mb-6">
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <p className="text-sm text-gray-600">
                ...
                {formData.gamerFirstName} {formData.gamerLastName}<br/>
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              <h3 className="font-semibold text-gray-800 mb-2">Treatment Preferences</h3>
              <p className="text-sm text-gray-600">
                Help Type: {formData.helpType}
                {formData.zoomLink && (
                  <>
                    <br/>
                    🔗 Zoom Link: {formData.zoomLink}
                  </>
                )}
              </p>
            </div>
          ...
          <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
            ...
            <p className="text-sm text-blue-700">
              By submitting this form, you agree to be contacted by our gaming addiction specialists. 
